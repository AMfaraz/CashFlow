...
class CompanyWaterScreen extends StatefulWidget {
  CompanyWaterScreen({Key? key}) : super(key: key);

  @override
  State<CompanyWaterScreen> createState() => _CompanyWaterScreenState();
}

class _CompanyWaterScreenState extends State<CompanyWaterScreen> {
  ...
  final String _selectedCompany="WASA";
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Water/Sanitation Bill"),
          actions: [
            Container(
